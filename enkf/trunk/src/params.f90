...
use radinfo, only: adp_anglebc,angord
...
logical,public :: wrf_regional = .false.
...
! check for mandatory namelist variables
   ...
   if(wrf_regional .and. .not. arw .and. .not. nmm) then
      print *, 'must select either arw or nmm wrf dynamical core'
      call stop2(19)
   endif
