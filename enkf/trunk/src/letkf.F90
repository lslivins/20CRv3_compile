...
!               obsmod, radinfo, radbias, gridinfo, common_mtx
!
! program history log:
...
use constants, only: constants_initialized, pi, one, zero, rad2deg, deg2rad
...
grdloop: do npt=1,numptsperproc(nproc+1)
   ...
   corrlength=latval(latsgrd(ngrd1)*rad2deg,corrlengthnh,corrlengthtr,corrlengthsh)
