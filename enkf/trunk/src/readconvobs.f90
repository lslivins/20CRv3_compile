...
subroutine get_num_convobs(obspath,datestring,num_obs_tot,id)
    ...
    character(len=64),allocatable,dimension(:):: cdiagbuf
...
subroutine get_convobs_data(obspath, datestring, nobs_max, h_x_ensmean, h_xnobc, x_obs, x_err, &
           x_lon, x_lat, x_press, x_time, x_code, x_errorig, x_type, x_obid, id, id2)
  ...
  character(len=64), dimension(nobs_max) ::  x_obid
  ...
  character(len=64),allocatable,dimension(:):: cdiagbuf,cdiagbuf2
