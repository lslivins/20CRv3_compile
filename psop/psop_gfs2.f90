program psop
 ...
 real dxob,dyob,dtob,zerr,anal_obt,anal_obp,anal_obpm1,wt,&
      ...
      rlapse, anal_obgph, anal_obgphm1
 ...
 namelist /nam_psop/nlevt,zerr,fhmin,fhmax,fhout,fhanal,datestring,&
                    nanals,nlons,nlats,obsfile,zthresh,errfact,delz_const,rlapse
