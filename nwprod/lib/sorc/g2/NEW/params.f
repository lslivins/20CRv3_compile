...
!$$$
      ...
      integer,parameter :: MAXPARAM=762
...
! Added 12/06/2010
       ...
       data paramlist(756) /gribparam(255,255,0,20,0,'MASSDEN')/
       data paramlist(757) /gribparam(255,255,0,20,1,'COLMD')/
       data paramlist(758) /gribparam(255,255,0,20,3,'AEMFLX')/
       data paramlist(759) /gribparam(255,255,0,20,9,'WLSMFLX')/
       data paramlist(760) /gribparam(255,255,0,20,11,'SEDMFLX')/
       data paramlist(761) /gribparam(255,255,0,20,12,'DDMFLX')/
       data paramlist(762) /gribparam(255,255,0,20,102,'AOTK')/
