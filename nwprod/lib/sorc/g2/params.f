...
! Added 12/06/2010
       ...
       data paramlist(756) /gribparam(142,0,0,20,0,'MASSDEN')/
       data paramlist(757) /gribparam(142,1,0,20,1,'COLMD')/
       data paramlist(758) /gribparam(142,3,0,20,3,'AEMFLX')/
       data paramlist(759) /gribparam(142,9,0,20,9,'WLSMFLX')/
       data paramlist(760) /gribparam(142,11,0,20,11,'SEDMFLX')/
       data paramlist(761) /gribparam(142,12,0,20,12,'DDMFLX')/
       data paramlist(762) /gribparam(142,102,0,20,102,'AOTK')/
