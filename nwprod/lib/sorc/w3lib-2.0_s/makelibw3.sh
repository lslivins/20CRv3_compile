...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -g -O3 -xHOST -convert big_endian -traceback -module $libinc/w3lib-2.0_4 -I $libinc/sigio_4 -I $libinc/w3lib-2.0_4"
 export AFLAGS=" "
...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -O3 -i8 -r8 -xHOST -convert big_endian -traceback -module $libinc/w3lib-2.0_8 -I $libinc/sigio_4 -I $libinc/w3lib-2.0_8"
 export AFLAGS=" "
 export CFLAGS=" -O3 -DLINUX -Dfunder -DUNDERSCORE -DFortranByte=char -DFortranInt=int -DFortranLlong='long long'"
fi
make -f make.libw3
...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -O3 -r8 -xHOST -convert big_endian -traceback -module $libinc/w3lib-2.0_d -I $libinc/sigio_4 -I $libinc/w3lib-2.0_d"
 export AFLAGS=" "
 export CFLAGS=" -O3 -DLINUX -Dfunder -DUNDERSCORE -DFortranByte=char -DFortranInt=int -DFortranLlong='long long'"
fi
make -f make.libw3
