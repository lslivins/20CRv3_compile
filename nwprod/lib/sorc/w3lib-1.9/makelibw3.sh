...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -O3 -xHOST -convert big_endian -traceback -module $libinc/w3_4 -I $libinc/sigio_4 -I $libinc/w3_4"
 export AFLAGS=" "
...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -O3 -i8 -r8 -xHOST -convert big_endian -traceback -module $libinc/w3_8 -I $libinc/sigio_4 -I $libinc/w3_8"
 export AFLAGS=" "
 export CFLAGS=" -O3 -DLINUX -Dfunder -DUNDERSCORE -DFortranByte=char -DFortranInt=int -DFortranLlong='long long'"
fi
make -f make.libw3
...
if [ $ncepxlf = xlf_r ] ; then
 ...
 export FFLAGS=" -O3 -r8 -xHOST -convert big_endian -traceback -module $libinc/w3_d -I $libinc/sigio_4 -I $libinc/w3_d"
 export AFLAGS=" "
 export CFLAGS=" -O3 -DLINUX -Dfunder -DUNDERSCORE -DFortranByte=char -DFortranInt=int -DFortranLlong='long long'"
fi
make -f make.libw3
