...
!
    ...
    call byteswap(data,nemsio_realkind,size(data))
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - -
    ...
    call byteswap(data4,nemsio_realkind,size(data4))
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - -
    ...
    call byteswap(data8,nemsio_dblekind,size(data8))
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - -
    ...
    call byteswap(data,nemsio_dblekind,size(data))
    call bafrwritel(myflunit,iskip,iwrite,nwrite,data)
    if(nwrite.lt.iwrite) return
    iret=0
