...
!meta5:reclev
      ...
      call byteswap(gfile%reclev,nemsio_intkind,size(gfile%reclev))
      if(nread.lt.iread) return
      nmeta=nmeta-1
      gfile%tlmeta=gfile%tlmeta+nread
...
!meta6:vcoord
      ...
      call byteswap(gfile%vcoord,nemsio_realkind,size(gfile%vcoord))
      if(nread.lt.iread) return
      nmeta=nmeta-1
      gfile%tlmeta=gfile%tlmeta+nread
...
!meta7:lat
      ...
      call byteswap(gfile%lat,nemsio_realkind,size(gfile%lat))
      if(nread.lt.iread) return
      nmeta=nmeta-1
...
!meta8:lon
      ...
      call byteswap(gfile%lon,nemsio_realkind,size(gfile%lon))
      if(nread.lt.iread) return
      nmeta=nmeta-1
...
!meta9:dx
      ...
      call byteswap(gfile%dx,nemsio_realkind,size(gfile%dx))
      if(nread.lt.iread) return
      nmeta=nmeta-1
...
!meta10:dy
      ...
      call byteswap(gfile%dy,nemsio_realkind,size(gfile%dy))
      if(nread.lt.iread) return
      nmeta=nmeta-1
...
!meta11:cpi
      ...
      call byteswap(gfile%Cpi,nemsio_realkind,size(gfile%Cpi))
      if(nread.lt.iread) return
      nmeta=nmeta-1
      gfile%tlmeta=gfile%tlmeta+nread
...
!Ri
      ...
      call byteswap(gfile%Ri,nemsio_realkind,size(gfile%Ri))
      if(nread.lt.iread) return
      nmeta=nmeta-1
      gfile%tlmeta=gfile%tlmeta+nread
...
!dy
    if ( nummeta.gt.0 ) then
      ...
      call byteswap(gfile%dx,nemsio_realkind,size(gfile%dy))
...
!Ri
    if ( nummeta.gt.0 ) then
      ...
      call byteswap(gfile%Cpi,nemsio_realkind,size(gfile%Ri))
