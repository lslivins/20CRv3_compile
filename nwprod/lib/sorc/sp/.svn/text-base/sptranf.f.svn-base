...
! 2012-11-09  MOORTHI  Moved SPTRANF0 call under openmp loop and
!                      declared private variables to make the code work
!                      on WCOSS
C
...
!$OMP PARALLEL DO PRIVATE(KWS,WTOP,G,IJKN,IJKS,k,j,i)
!$omp+private(EPS,EPSTOP,ENN1,ELONN1,EON,EONTOP)
!$omp+private(AFFT,CLAT,SLAT,WLAT,PLN,PLNTOP)
        DO K=1,KMAX
