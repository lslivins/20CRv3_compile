...
#export FCMP=${1:-${FCMP:-"ifort -auto -openmp"}}
#export FCMP=${1:-${FCMP:-"ifort"}}
export FCMP=${1:-${FCMP:-"ftn"}} # try cray wrapper G. Compo 9 Feb 2017
#
...
#export FFLAGS=" -O2 -i4 -xHOST -convert big_endian -align dcommon"
 export FFLAGS="-O3 -i4 -convert big_endian -assume byterecl -fp-model strict -real-size 32 -fpp -DLINUX"
 export AFLAGS=" "
fi
make -f make.libsp
#
...
#export FFLAGS=" -O2 -i8 -r8 -xHOST -convert big_endian -align dcommon"
 export FFLAGS=" -O3 -i8 -r8 -convert big_endian -assume byterecl -fp-model strict -fpp -DLINUX"
 export AFLAGS=" "
fi
make -f make.libsp
#
...
#export FFLAGS=" -O0 -i4 -r8 -xHOST -convert big_endian -align dcommon -g -traceback"
#export FFLAGS=" -O2 -i4 -r8 -xHOST -convert big_endian -align dcommon"
 export FFLAGS=" -O3 -i4 -r8 -convert big_endian -assume byterecl -fp-model strict -fpp -DLINUX"
 export AFLAGS=" "
fi
make -f make.libsp
