...
C$$$
     ...
     . ' (all warning+informational)'/
      ...
      print *,' Inside OPENBF : ',LUNIT,IO,LUNDX
C-----------------------------------------------------------------------
C-----------------------------------------------------------------------
...
!     print *,' Inside OPENBF  before STATUS: '
      CALL STATUS(LUNIT,LUN,IL,IM)
!     print *,' Inside OPENBF  after STATUS: ',' LUN=',LUN,' IL=',IL
...
!        READ(LUNIT,END=200,ERR=902) (BSTR(I),I=1,4)
         READ(LUNIT,END=200        ) (BSTR(I),I=1,4)
      print *,' IN OPENBF BSTR=',BSTR(1:4),' ICHK=',
     &ICHKSTR('BUFR',BSTR,4)
...
C  ----------------------------------
      ...
      IF(IO.EQ.'IN') THEN
!      print *,' Calling WTSTAT'
         CALL WTSTAT(LUNIT,LUN,-1,0)
!      print *,' Calling READDX'
...
!      print *,' After Calling READDX going to 100'
      GOTO 100
