...
\$(LIB):	\$(LIB)( bacio.v1.4.o baciof.o bafrio.o byteswap.o)
...
export INC="clib4.h"
export FFLAGS=" -O3 -xHOST -convert big_endian"
export AFLAGS=
...
export INC="clib8.h"
export FFLAGS=" -O3 -xHOST -convert big_endian -i8 -r8"
export AFLAGS=
export CFLAGS=" -O3 -DLINUX -longlong "
make -f make.bacio
