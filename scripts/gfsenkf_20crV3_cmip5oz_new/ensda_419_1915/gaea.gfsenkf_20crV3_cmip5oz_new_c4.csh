...
#PBS -q urgent
##PBS -q debug
#PBS -l walltime=00:49:16
#PBS -N gfsenkf_415_1915
#PBS -e gfsenkf.err
#PBS -o gfsenkf.out
#PBS -S /bin/csh
setenv nhosts 2880  # this must make "-l size" above!
...
set path = ( $path /lustre/f1/unswept/Gilbert.P.Compo/20CRV3_c420/bin )
...
setenv corespernode 36
setenv corespernumanode 18
...
# gil is using 20CRV3_c4 but only the "new" kind
setenv basedir /lustre/f1/unswept/${USER}/20CRV3_c4
...
setenv datapath "${datadir}/gfsenkf_20crV3_cmip5oz_c4/${expname}/" # backslash at end of path necessary

# Data reside in obs directory set dynamically in loop below ${obsdir}

# log directory
setenv logdir "${datadir}/logs_c4/${expname}"
...
cd ${enkfscripts}
msub gfsenkf_20crV3_cmip5oz_new_c4.csh >&! current_jobid
