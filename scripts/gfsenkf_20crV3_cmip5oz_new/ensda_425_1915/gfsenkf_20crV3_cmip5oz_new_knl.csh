...
setenv fg_omp_threads 2# number of OMP threads for the GFS and the ENKF
...
if (($day == '01' || $day == '10' || $day == '20') && $hr == '00') then
   ...
   /bin/rm -f ${datapath2}/pgrbfg*mem* &# eventually will want this
