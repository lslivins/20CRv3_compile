#!/bin/ksh
export LIBDIR=/lustre/f1/unswept/Jeffrey.S.Whitaker/20CRV3/nwprod/lib
export ESMFDIR=/lustre/f1/unswept/Jeffrey.S.Whitaker/20CRV3/nwprod/lib
...
export LDRM="ftn"
export FCC=cc
export LDFLAGSM="$PGSZM -openmp"            #raghu.reddy
...
export LIBSM="-L$LIBDIR  -lbacio_4 -lnemsio -lsp_d -l$W3LIB -lrt -L$ESMFDIR -lesmf_3_1_0rp5 -lstdc++"
