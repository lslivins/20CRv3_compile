...
! gpc added dswrf_toa
  ...
  integer,parameter:: iflxs_dswrf_toa         =63	
  ...
  data jpdsflxs(19,iflxs_dswrf_toa         ) /002/
  ...
  data jpdsflxs(5:7,iflxs_dswrf_toa         ) /204,008,000/
...
!  output flux fields (scalar)
  ...
  integer,parameter:: ifoxs_dswrf_toa         =68
  ...
  data jpdsfoxs(19,ifoxs_dswrf_toa         ) /002/
  ...
  data jpdsfoxs(5:7,ifoxs_dswrf_toa         ) /204,008,000/
...
!  output height-level fields (scalar)
  ...
  ! jsw- changed 103 to 105 below (above ground, not above MSL)
  data jpdszzs(5:6,izzs_tmp_hml             ) /011,105/
  data jpdszzs(5:6,izzs_rh_hml              ) /052,105/
!  output height-level fields (vector)
  ...
  ! jsw- changed 103 to 105 below (above ground, not above MSL)
  data jpdszzu(5:6,izzu_ugrd_hml            ) /033,105/
  data jpdszzv(5:6,izzv_vgrd_hml            ) /034,105/
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
