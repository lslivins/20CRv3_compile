...
!cggg     &          SLPJMX=9.0,SLPJMN=9.0) 
     ...
     &          SLPJMX=0.,SLPJMN=0.) 
!cggg landice mods end
      PARAMETER(ABSLMX=0.80,ABSLMN=0.01,ABSOMX=0.0,ABSOMN=0.0,
     &          ABSSMX=0.80,ABSSMN=0.01,ABSIMX=0.0,ABSIMN=0.0,
...
!
     ...
     &        kpdvet,kpdsot,kpdstc,kpdveg,jmsk,imsk,j
!Clu [+1L] add kpd() for vmn, vmx, slp, abs
     &,       kpdvmn,kpdvmx,kpdslp,kpdabs
      INTEGER kpdalb(4), kpdalf(2)
!
...
!       CALL DGEF(AWORK1,JHE,JHO,IPVT)
        call ludcmp(awork1,jho,jhe,ipvt)
!       CALL DGES(AWORK1,JHE,JHO,IPVT,BWORK,J0)
        call lubksb(awork1,jho,jhe,ipvt,bwork)
